...
<header class="top-nav-bar" id="mainHeader">
    ...
    <div class="hero-signin-container" id="authContainer">
        ...
        @if(auth()->check())
            ...
            <a href="{{ route('dashboard') }}" class="auth-btn username">
...
<div class="main-content" id="pageWrapper">
    ...
    <section id="home">
        <div class="hero-container">
            {{-- ✅ Use your existing images (change filenames if needed) --}}
    ...
    <div class="detail-container">
        ...
        <div class="detail-info-panel">
            ...
            <div class="custom-option-group">
                ...
                <select class="custom-select" id="printCategory" onchange="updatePrice()"></select>
            </div>

            <div class="custom-option-group">
                <label>Color Mode</label>
                <select class="custom-select" id="colorMode" onchange="updatePrice()"></select>
            </div>

            <div class="custom-option-group">
                <label>Paper Size / Product Size</label>
                <select class="custom-select" id="paperSize" onchange="updatePrice()"></select>
            </div>
