...
<div class="wrap">
    <div class="card">
        ...
        <p>Your payment was completed. Thank you for your order.</p>

        <div class="btnrow">
            <a class="btn" href="{{ url('/') }}">Back to Home</a>
            <a class="btn secondary" href="{{ route('payment.checkout') }}">Checkout Again</a>
        </div>

        <div class="note">
            If you were redirected here by mistake, you may return to the homepage.
        </div>
    </div>
</div>
</body>
